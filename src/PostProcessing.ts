...
const float EDGE_THRESHOLD_MAX = 1.0;
...
void main() {
    ...
    vec3 rgbM  = texture(u_texture, screenTexCoords).rgb;
...
{    
    ...
    public applyPostProcessing(w: number, h: number) {
    ...
    public render(w: number, h: number, canvas: HTMLCanvasElement) {
